...
func (a *Activities) AppendNote(ctx context.Context, refID string, n *notes.Note) error {
	if refID == "" {
...
func (a *Activities) GetNotes(ctx context.Context, refID string) ([]*models.Message, error) {
	ref, err := a.Refs.Get(refID)
	if err != nil {
...
func (a *Activities) Generate(ctx context.Context, req *models.Request) ([]*models.Message, error) {
	var msgs []*models.Message
...
func (a *Activities) ToolCall(ctx context.Context, tc *models.ToolCall) (string, error) {
